...
load-test/03-ss-select:
	...
	bash ./run-demo.sh ./cmake-build-debug/03-ss-select/03-ss-select ./cmake-build-debug/client/client 20000 1 30
...
load-test/04-ss-poll:
	...
	bash ./run-demo.sh ./cmake-build-debug/04-ss-poll/04-ss-poll ./cmake-build-debug/client/client 20000 1 30
...
load-test/05-ss-epoll:
	...
	bash ./run-demo.sh ./cmake-build-debug/05-ss-epoll/05-ss-epoll ./cmake-build-debug/client/client 20000 1 30
...
metrics/03-ss-select: metrics/03-ss-select-10  metrics/03-ss-select-1000  metrics/03-ss-select-2500  metrics/03-ss-select-10000 metrics/03-ss-select-20000
...
metrics/03-ss-select-20000:
	bash get-metrics.sh 03-ss-select-20000-output.log

metrics/04-ss-poll: metrics/04-ss-poll-10  metrics/04-ss-poll-1000  metrics/04-ss-poll-2500  metrics/04-ss-poll-10000 metrics/04-ss-poll-20000
...
metrics/04-ss-poll-20000:
	bash get-metrics.sh 04-ss-poll-20000-output.log

metrics/05-ss-epoll: metrics/05-ss-epoll-10 metrics/05-ss-epoll-1000 metrics/05-ss-epoll-2500 metrics/05-ss-epoll-10000 metrics/05-ss-epoll-20000
...
metrics/05-ss-epoll-20000:
	bash get-metrics.sh 05-ss-epoll-20000-output.log
